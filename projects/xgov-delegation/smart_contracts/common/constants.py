...
INCENTIVE_ELIGIBLE_FEE: Final[int] = 2_000_000  # 2 ALGO in microAlgos
MIN_FEE: Final[int] = 1_000  # 0.001 ALGO in microAlgos

MAX_PAGES_PER_APP: Final[int] = 4
MAX_EXTRA_PAGES_PER_APP: Final[int] = MAX_PAGES_PER_APP - 1
...
PER_UINT_SLICE_ENTRY_MBR: Final[int] = 28_500  # 0.0285 ALGO in microAlgos
...
MIN_PROGRAM: Final[bytes] = b"\n\x81\x01C"
MAX_STACK_WIDTH: Final[int] = 4092
